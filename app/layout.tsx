...
const caveat = Caveat({ subsets: ["latin"], variable: '--font-heading', weight: ['400', '500', '600', '700'], display: 'swap' });
const patrickHand = Patrick_Hand({ subsets: ["latin"], variable: '--font-body', weight: '400', display: 'swap' });
const indieFlower = Indie_Flower({ subsets: ["latin"], variable: '--font-accent', weight: '400', display: 'swap' });
const fredoka = Fredoka({ subsets: ["latin"], variable: '--font-display', weight: ['500', '600', '700'], display: 'swap' });

export const metadata: Metadata = {
  metadataBase: new URL('https://myportfolio-2905.web.app'),
  ...
  alternates: {
    canonical: 'https://myportfolio-2905.web.app',
  },
  openGraph: {

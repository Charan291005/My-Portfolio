...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <Mascot className="absolute top-20 right-10 lg:right-32 w-32 h-32 md:w-48 md:h-48 opacity-90 hidden sm:block" pose="floating" />
      ...
      <div className="relative z-10 section-container text-center pt-24">
        ...
        >
          ...
          {/* Intro line */}
          <motion.p
            className="text-xl md:text-2xl font-accent text-ink-light mb-4"
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.2, duration: 0.6 }}
          >
            Hi, I'm Shree Charan N.
          </motion.p>

          {/* Big Punchy Tagline */}
          <div className="relative inline-block mb-8 max-w-[90vw] px-4">
            <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-[7rem] leading-tight font-heading font-bold text-ink relative z-10">
              Breaking systems to make them <br className="hidden md:block" />
              <span className="text-pop inline-block rotate-[-2deg]">unbreakable.</span>
            </h1>

            {/* Sparkle decoration */}
            <motion.svg
              className="absolute -top-8 -right-8 w-20 h-20 text-highlight-yellow opacity-80"
            ...
            >
              <path d="M50,10 L50,30 M50,70 L50,90 M10,50 L30,50 M70,50 L90,50 M25,25 L40,40 M60,60 L75,75 M25,75 L40,60 M60,40 L75,25" stroke="currentColor" strokeWidth="4" strokeLinecap="round" />
            </motion.svg>
            
            {/* Sparkle decoration 2 */}
            <motion.svg
              className="absolute bottom-4 -left-8 w-12 h-12 text-pencil-blue opacity-70"
            ...
            >
              <path d="M50,15 L50,85 M15,50 L85,50 M25,25 L75,75 M25,75 L75,25" stroke="currentColor" strokeWidth="4" strokeLinecap="round" />
            </motion.svg>
          </div>

          <motion.p
            className="text-lg md:text-xl font-body text-ink-light mb-10 max-w-2xl mx-auto"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.8, duration: 0.6 }}
          >
            I'm a Cybersecurity Engineer & Developer specializing in cryptography, secure file protection, and digital forensics. Let's build something secure.
          </motion.p>
